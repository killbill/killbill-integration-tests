...
module KillBillIntegrationTests
  ...
  class TestPauseResume < Base
    ...
    def test_with_ao
      ...
      sort_invoices!(all_invoices)
      third_invoice = all_invoices[2]
      check_invoice(third_invoice, 7.18, 'USD', "2013-09-02", 0)
      ...
      third_invoice = all_invoices[2]
      check_invoice(third_invoice, 0.77, 'USD', "2013-09-02", 0)
      ...
      check_invoice(fourth_invoice, 327.730, 'USD', "2013-09-10", 0)
      ...
      check_events(ao1.events, [{:type => "START_ENTITLEMENT", :date => "2013-09-02"},
