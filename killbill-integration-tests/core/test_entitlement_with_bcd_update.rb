...
module KillBillIntegrationTests
  class TestEntitlementBCDUpdateTest < Base
    ...
    def test_with_bcd_change_in_the_future_v1
      ...
      bp.change_plan({ productName: 'Basic', billingPeriod: 'ANNUAL', priceList: 'DEFAULT' }, @user, nil, nil, effective_from_date, nil, nil, false, @options)
      ...
      check_invoice_item(second_invoice.items[0], second_invoice.invoice_id, 10_000.00, 'USD', 'RECURRING', 'basic-annual', 'basic-annual-evergreen', '2013-08-16', '2014-08-16')
