...
module KillBillIntegrationTests
  class TestMigrationScenario < Base
    ...
    def test_migration_scenario
      ...
      check_invoice_no_balance(third_invoice, 10_000.00, 'USD', '2013-08-10')
      check_invoice_item(third_invoice.items[0], third_invoice.invoice_id, 10_000.00, 'USD', 'RECURRING', 'basic-annual', 'basic-annual-evergreen', '2013-08-10', '2014-08-10')
