...
module KillBillIntegrationTests
  class TestEntitlementAddOn < Base
    ...
    def test_cancel_bp_with_cancel_date_and_uncancel
      ...
      assert_equal_dates('2013-08-01', bp.events[0].effective_date)
      ...
      assert_equal_dates('2013-08-01', bp.events[1].effective_date)
      ...
      assert_equal_dates('2013-08-06', bp.events[2].effective_date)
      ...
      assert_equal_dates('2013-08-06', bp.events[3].effective_date)
      ...
      assert_equal_dates('2013-08-31', bp.events[2].effective_date)
