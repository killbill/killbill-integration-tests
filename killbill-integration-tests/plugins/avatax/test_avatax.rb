...
module KillBillIntegrationTests
  class TestAvaTax < KillBillIntegrationTests::PluginBase
    ...
    def setup
      ...
      if ENV['AVATAX_ACCOUNT_ID'].nil?
        puts "\e[36mAvaTax credentials not provided - assuming the plugin is globally configured\e[0m"
      else
    ...
    def test_adjust_tax_after_repair
      ...
      all_invoices   = check_next_invoice_amount(3, total_amount_after_taxes_third, '2020-06-02', @account, @options, &@proc_account_invoices_nb)
    ...
    def test_adjust_tax_after_item_adjustment_with_cba
      ...
      check_invoice_no_balance(invoice, total_invoice_after_adjustment.round(2), 'USD', '2020-05-01')
      ...
      check_invoice_item(item_adjustment.first, invoice.invoice_id, amount_adj, 'USD', 'ITEM_ADJ', nil, nil, '2020-05-01', '2020-05-01')
